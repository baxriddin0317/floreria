      ...
      <div className="flex flex-col xl:flex-row items-center justify-between">
        <div className="xl:w-[460px] mb-10 sm:mb-0">
          ...
          <button className="flex items-center gap-3 mt-30 btn-hover text-white  rounded-30 py-3 px-30 md:py-5 md:px-12">
            <span className="text-base">Entrega Inmediata</span>
      ...
      <div className="flex items-center xl:items-end flex-col xl:flex-row w-full bg-dark-color text-white rounded-20 py-5 gap-12 px-2 md:px-10 ">
        ...
        >
          <div className="flex flex-col xl:w-[260px] md:w-1/2 w-4/5 mx-auto">
            <label
              htmlFor="Donde"
              className="font-bold text-sm text-label mb-2.5"
            >
              ¿Donde envías?
            </label>
            <input
              className="w-full text-gray-text text-base outline-none h-10 pl-5 rounded-10"
              type="text"
              id="Donde"
              placeholder="Comuna"
            />
          ...
          <div className="flex flex-col xl:w-[260px] md:w-1/2 w-4/5 mx-auto">
            ...
            <div className="relative">
              ...
              <select
                className="w-full outline-none h-10 pl-5 rounded-10 relative"
                id="Ocasion"
              >
          ...
          <div className="flex flex-col xl:w-[260px] md:w-1/2 w-4/5 mx-auto">
            ...
            <input
              className="w-full text-gray-text outline-none h-10 pl-5 rounded-10"
              type="date"
              id="Cuando"
            />
          </div>
